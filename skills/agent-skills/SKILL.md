---
name: Agent Skills
description: Explain, inspect, create, and maintain XiaoDun Agent Skills packages built around SKILL.md instructions.
tags:
  - skills
  - agent
  - workflow
...
Use this skill when the user asks about XiaoDun skills, wants to list installed skills, or wants to create a reusable workflow package.

## XiaoDun Skill Format

A XiaoDun Agent Skill is a folder under the configured skills root. The required file is `SKILL.md`.
...
- Keep `description` specific. XiaoDun uses it during skill selection.
