...
${MODEL_CATALOG_TEXT}`,
      },
      {
        ...
        content: `小盾首选大模型，国产高性能、性价比出色、中文效果好。
...
文档：https://platform.deepseek.com/api-docs`,
      ...
      {
        title: 'MiniMax 配置',
        content: `MiniMax \u4ec5\u7528\u4e8e\u5927\u8bed\u8a00\u6a21\u578b\uff08LLM\uff09\u8c03\u7528\uff0cAPI Key \u53ea\u7528\u4e8e\u6a21\u578b\u670d\u52a1\u3002
...
→ OpenAI 代理：baseURL = https://your-proxy.com/v1，apiKey = sk-xxx`,
    ...
    providers: [
      ...
      { name: 'MiniMax', url: 'https://platform.minimaxi.com/', free: false, note: '\u4ec5\u7528\u4e8e\u5927\u8bed\u8a00\u6a21\u578b\u8c03\u7528' },
