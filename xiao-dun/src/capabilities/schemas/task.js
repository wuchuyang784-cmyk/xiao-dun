// 浠诲姟 / 鑺傚绫诲伐鍏?schema锛歴et_tick_interval / set_task / complete_task /
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          results: {
            type: 'object',
            description: 'Per-capability result map. Suggested keys: filesystem, web_search, hotspot_panel, focus_banner, ui_card. Each value should include status and detail.',
