...
const SCHEDULED_REMINDER_TRIGGERS = [
  '定时提醒', '定时推送', '定时采集', '自动推送', '自动采集',
  '开启定时', '关闭定时', '定时配置', '推送时间', '推送间隔',
  '每天推送', '定时反诈', '定时任务', 'schedule', 'reminder',
  'scheduled reminder', '定时提醒功能',
]
...
export const TOOL_GROUPS = [
  ...
  { triggers: SCHEDULED_REMINDER_TRIGGERS, tools: ['scheduled_reminder'] },
