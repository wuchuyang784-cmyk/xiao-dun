...
const ROLE_RULES = [
  {
    ...
    keywords: [/xiaodun/i, /agent/i, /llm/i, /prompt/i, /context/i, /memory/i, /codex/i, /claude/i, /openai/i, /minimax/i],
  ...
  },
  {
    ...
    keywords: [/video/i, /audio/i, /image/i, /animation/i, /render/i],
...
function inferProjects(text) {
  const projects = []
  if (/xiaodun/i.test(text) || /小盾/.test(text)) projects.push('XiaoDun')
